...
wget https://raw.githubusercontent.com/vivechanchanny/aws/main/lamp/cloud-init.sh -O cloud-init.sh
wget  https://raw.githubusercontent.com/vivechanchanny/aws/main/utils/create-secgrp.sh -O create-secgrp.sh 
bash create-secgrp.sh video-scg
